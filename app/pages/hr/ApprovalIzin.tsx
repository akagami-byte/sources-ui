...
const initialData: IzinData[] = [
  { id: 1, nama: "Budi Santoso", dept: "Teknologi Informasi", nip: "KRY-2024-001", jenis: "Sakit", tanggal: "10 Mei 2026", keperluan: "Demam tinggi dan flu sejak kemarin. Tidak dapat masuk kerja.", status: "Pending" },
  { id: 2, nama: "Siti Rahayu", dept: "Marketing", nip: "KRY-2023-015", jenis: "Keperluan Pribadi", tanggal: "12 Mei 2026", keperluan: "Urusan keluarga mendesak yang tidak dapat ditunda.", status: "Pending" },
  { id: 3, nama: "Ahmad Fauzi", dept: "Finance", nip: "KRY-2022-008", jenis: "Telat", tanggal: "09 Mei 2026", keperluan: "Macet parah di tol Cipali arah Jakarta.", status: "Pending" },
  { id: 4, nama: "Dewi Kusuma", dept: "HR", nip: "KRY-2021-003", jenis: "Izin Beberapa Jam", tanggal: "08 Mei 2026", keperluan: "Kontrol dokter spesialis jam 10.00 - selesai.", status: "Approved", tglProses: "08 Mei 2026" },
  { id: 5, nama: "Rian Pratama", dept: "Operations", nip: "KRY-2024-012", jenis: "Sakit", tanggal: "05 Mei 2026", keperluan: "Sakit perut, demam.", status: "Rejected", alasan: "Tidak ada surat keterangan dokter. Mohon lampirkan bukti.", tglProses: "06 Mei 2026" },
];

const filterOptions = ["Semua", "Pending", "Approved", "Rejected"];

export function ApprovalIzin() {
  const [data, setData] = useState<IzinData[]>(initialData);
  const [filter, setFilter] = useState("Semua");
  const [search, setSearch] = useState("");
  const [selected, setSelected] = useState<IzinData | null>(null);
    ...
    <div className="flex flex-col h-full" style={{ background: "#F5F7FA" }}>
      ...
      >
        <div className="flex items-center justify-between mb-1">
          <h2 style={{ color: "white", fontSize: 22, fontWeight: 700 }}>Approval Izin</h2>
          {pendingCount > 0 && (
            <span
              className="px-2 py-1 rounded-full"
              style={{ background: "#FFA726", color: "white", fontSize: 12, fontWeight: 700 }}
            >
        ...
        <p style={{ color: "rgba(255,255,255,0.7)", fontSize: 13 }}>
          Review dan setujui pengajuan izin karyawan
        </p>
        ...
        <div className="mt-4 relative">
          ...
          <input
            ...
            placeholder="Cari karyawan atau jenis izin..."
            style={{
              width: "100%",
              height: 40,
        ...
        {filtered.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p style={{ fontSize: 13, color: "#9E9E9E", marginTop: 4 }}>
              Tidak ditemukan data dengan filter ini
            </p>
          </div>
        ) : (
              ...
              >
                ...
                >
                  ...
                  <div className="flex gap-4">
                    ...
                    <span style={{ fontSize: 12, color: "#616161" }}>Tgl: <strong style={{ color: "#001A4D" }}>{item.tanggal}</strong></span>
                  </div>
                </div>
              </button>
            ))}
      ...
      >
        {selected && (
          <div className="space-y-1">
            ...
            <InfoRow label="Jenis Izin" value={selected.jenis} />
            ...
            <div className="py-3" style={{ borderBottom: "1px solid #F0F0F0" }}>
              ...
              <p style={{ fontSize: 14, color: "#001A4D", lineHeight: 1.6 }}>{selected.keperluan}</p>
            </div>
            {selected.tglProses && (
              <InfoRow label="Tgl Diproses" value={selected.tglProses} />
            )}
            {selected.alasan && (
      ...
      >
        ...
        <p style={{ fontSize: 12, color: "#9E9E9E", marginBottom: 12 }}>
          Alasan ini akan dikirimkan ke karyawan sebagai notifikasi.
        </p>
        <textarea
          value={rejectReason}
          onChange={(e) => {
